...
@section('title','Edit Help Categories')
@section('content')
<div id="content" class="content">
    <ol class="breadcrumb float-xl-right">
        <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{route('helpcategory.index')}}">Help Categories</a></li>
        <li class="breadcrumb-item active">Edit Help Categories</li>
    </ol>
        ...
        <div class="col-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Edit Help Category</h4>
                    <div class="panel-heading-btn">
                        <a href="{{ route('helpcategory.index') }}" class="btn btn-info btn-sm mr-2"><i class="fa fa-list"></i> Help Category List</a>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form action="{{route('helpcategory.update',$data->id)}}" method="post">
                                @csrf
