                    ...
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><img style="padding:4px;border:1px solid gray; margin: 10px 0; width:100px;" src="@if(!empty($row->brand_logo)) {{asset($row->brand_logo)}} @else {{asset('defaults/noimage/no_img.jpg')}} @endif" alt="image"></td>
                                <td>
            ...
            <form action="{{route('brand.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input id="defaultImage" type="file" name="brand_logo" class="form-control">
