            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-btn">
                        <a href="{{ route('notice.create') }}" class="btn btn-info btn-xs mr-2"><i class="fa fa-plus-circle"></i> Add New</a>
                ...
                <div class="panel-body">
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                        <thead>
                            <tr>
                                <th>SL</th>
                                <th class="text-nowrap">Notice Image</th>
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="{{route('notice.show',$blog->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> View</a>
                                    <a href="{{route('notice.edit',$blog->id)}}" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Edit</a>
                            ...
                            <div class="modal fade" id="blog_status_{{$blog->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{route('notice.status', $blog->id)}}" method="post">
                                            @csrf
