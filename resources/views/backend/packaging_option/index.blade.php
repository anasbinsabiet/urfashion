                    ...
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>{{$row->packaging_option}}</td>
                                <td>
                                    <a href="{{route('packagingoption.edit',$row->id)}}" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                    <a id="delete" href="{{route('packagingoption.destroy',$row->id)}}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('packagingoption.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="">Sleeve Length Name</label>
                        <input type="text" name="packaging_option" placeholder="Enter Sleeve Length Name" class="form-control">
