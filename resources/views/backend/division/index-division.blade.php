        ...
        <div class="col-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">District List</h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">District Add</h5>
            ...
            @csrf
                <div class="modal-body">
                    ...
                    <input type="text" name="division_name" placeholder="District name" class="form-control">
