...
<div id="indexc">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="javascript:void(0);" lang="en">Sign In</a></li>
        </ul>
        <div class="errorMessage"></div>
        
        <div class="col-sm-12">
            <div class="row">
                <div class="col-md-6 col-sm-12" id="loginBox">  
                    <div class="loginblock userblock">
                        <h2 class="userblock-title" lang="en">Returning Customers Login</h2>
                        <form name="LogonForm" id="LogonForm" action="{{ route('login') }}" method="post">
                            @csrf
                            <div class="from_fieldBox">
                                <label lang="en">Email/Mobile</label>
                                <input name="username" id="username" type="text" value="" aria-label="Email">
                                <div style='color:red; padding: 0 5px;'>{{($errors->has('username'))?($errors->first('username')):''}}</div>
                            </div>
                            <div class="from_fieldBox">
                                <label lang="en">Password</label>
                                <input name="password" type="password" id="password" autocomplete="off" disableautocomplete="" aria-label="Password">
                                <div style='color:red; padding: 0 5px;'>{{($errors->has('password'))?($errors->first('password')):''}}</div>
                                <p class="loginbtn" lang="en"><input type="submit" value="Login" id="loginbtn"></p>
                            </div>
                        </form>
                        <!-- <p class="forpass" lang="en">Forgot Your Password? <a href="/forgotpwd.jsp" lang="en">Click Here</a></p> -->
                        <p class="forpass" lang="en">Forgot Your Username? Please Call 1-800-748-6150</p>
                        <p lang="en">If you are experiencing any issue with your account information, please call 1-800-748-6150 to speak with a customer service representative.</p>
                        <p lang="en">Your email address will serve as your Username on the Promo Direct website.</p>
                        ...
                        <div class="secureiconsBox" lang="en">
                            ...
                            <div class="trustpilot-widget" data-locale="en-US" data-template-id="5419b6ffb0d04a076446a9af" data-theme="light" data-businessunit-id="4d9132a700006400050f4273" data-style-height="20px" data-style-width="100%" align="center" style="position: relative;" lang="en"><iframe title="Customer reviews powered by Trustpilot" loading="auto" src="https://widget.trustpilot.com/trustboxes/5419b6ffb0d04a076446a9af/index.html?templateId=5419b6ffb0d04a076446a9af&amp;businessunitId=4d9132a700006400050f4273#locale=en-US&amp;theme=light&amp;styleHeight=20px&amp;styleWidth=100%25" style="position: relative; height: 20px; width: 100%; border-style: none; display: block; overflow: hidden;"></iframe></div>
                        </div>
                    </div>
                </div>      
                <div class="col-md-6 col-sm-12" id="newloginBox">
                    <div class="newloginblock userblock">
                        <h2 class="userblock-title" lang="en">New Customers - Create Account</h2>
