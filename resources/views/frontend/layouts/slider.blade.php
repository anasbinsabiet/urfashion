	...
	<div class="banner">
		...
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="banner_product_image"><img src="{{asset(isset($slider->default_image) ? $slider->default_image : '')}}" alt=""></div>
				<div class="col-lg-5 offset-lg-4 fill_height">
					<div class="banner_content">
						{{-- isset($slider->product_name) ? $slider->product_name : '' --}}
						<h1 class="banner_text">{{isset($slider->product_name) ? $slider->product_name : ''}}</h1>
