					...
					<div class="col d-flex flex-row">
						...
						<div class="top_bar_content ml-auto">
							...
							<div class="top_bar_user">
								...
								@else
								<a href="{{ route('logout') }}" onclick="event.preventDefault();  document.getElementById('logout-form').submit();" class="dropdown-item"><i class="fa fa-sign-out"></i> Sign Out</a>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="{{url('/')}}">Imran</a></div>
						</div>
					</div>
						...
						<div class="header_search">
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form id="search-form" action="{{ url('/searching') }}" method="POST" class="header_search_form clearfix">
										@csrf
                                            <input type="text" name="search_product" id="search_text" placeholder="Search for products..." class="header_search_input">
							...
							<div class="cart">
								<div class="cart_container d-flex flex-row align-items-center justify-content-end">
									...
									<div class="cart_content">
										...
										<div class="cart_price">$<span class="cartTotal"></span></div>
									</div>
								</div>
							</div>
						</div>
