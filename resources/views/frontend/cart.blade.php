				...
				<div class="row aiz-steps arrow-divider">
					...
					<div class="col">
						<div class="text-center">
							...
							<h3 class="fs-14 fw-600 d-none d-lg-block opacity-50">2. Checkout</h3>
						</div>
					</div>
					<!-- <div class="col">
						<div class="text-center">
				...
				<div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
					...
					<div id="has_cart_page" style="display: none;">
								...
								<li class="list-group-item px-0 px-lg-3 cartpage" id="{{$product->id}}">
									<div class="row gutters-5">
										...
										<div class="col-lg col-4 order-1 order-lg-0 my-3 my-lg-0">
											...
											<span class="fw-600 fs-16">@isset($details['selling_price']){{$details['selling_price']}}@endisset৳</span>
										</div>
										...
										<div class="col-lg col-6 order-4 order-lg-0">
											<div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0">
												<div class="input-group quantity">
													...
													<input type="number" onchange="updateCart({{ $product->id }})" class="qty-input form-control" name="cart_quantity" max="{{$product->product_quantity}}" value="{{$details['qty']}}">
										...
										<!-- <div class="col-lg col-4 order-3 order-lg-0 my-3 my-lg-0">
                                                ...
                                                <span class="fw-600 fs-16 text-primary" id="item_total">0</span>৳
                                            </div> -->
						...
						<div class="px-3 py-2 mb-4 border-top d-flex justify-content-between">
							...
							<span class="fw-600 fs-17" id="cart_page_subtotal">0</span>
						</div>
						<div class="px-3 py-2 mb-4 border-top d-flex justify-content-between">
							<span class="opacity-100 fs-15">Total Selling Price</span>
							<span class="fw-600 fs-17" id="selling_subtotal">0</span>
						</div>
					</div>
					@endif
			...
			$(document).ready(function() {
				...
				$('.changeQuantity').click(function(e) {
					...
					$.ajax({
						...
						success: function(response) {
							$(this).closest(".cartpage").find('#item_quantity').html(quantity);
							cartData();
							cartCount();
							cartTotal();
							sellingTotal();
