    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-lg-6 text-center text-lg-left">
                <h1 class="fw-600 h4 m-0 text-left">Tutorial</h1>
            </div>
            <div class="col-lg-6">
                <ul class="breadcrumb bg-transparent p-0 justify-content-center justify-content-lg-end">
                    ...
                    <li class="text-dark fw-600 breadcrumb-item">
                        <a class="text-reset" href="javascript:void(0);">"Tutorial"</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div id="indexc">
	<div class="container">
	<div id="breadcrumbs" class="me-auto" data-v-15e8495b="">
					...
					<div class="col-xs-12 col-sm-4 col-md-4">
						<article id="post-3431" class="genaral-post-item post-3431 post type-post status-publish format-standard has-post-thumbnail hentry category-business-appreciation-gifts category-business-giveaways tag-bamboo-promotional-products tag-eco-friendly-bamboo-promotional-items tag-sustainable-promotional-products">
							<figure class="genpost-featured-image">
								<a href="{{url(route('help'))}}/{{$rows->slug_en}}" title="{{$rows->title_en}}"><img width="100%" height="220" @if($rows->image) src="{{url($rows->image)}}" @else src="{{url('defaults/noimage/no_img.jpg')}}" @endif sizes="(max-width: 388px) 100vw, 388px"></a>
							</figure>

							<header class="genpost-entry-header">
								<h2 class="single-entry-title entry-title m-0 text-left"><a href="{{url(route('blog'))}}/{{$row->slug_en}}" rel="bookmark">{{$rows->title_en}}</a></h2>
							</header><!-- .entry-header -->

							<div class="genpost-entry-content">
								{!! \Illuminate\Support\Str::words($rows->description_en, 30) !!}
