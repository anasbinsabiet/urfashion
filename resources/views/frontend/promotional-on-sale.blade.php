...
<div id="category" class="container">
	<ul class="breadcrumb">
		...
		<li><a href="javascript:void(0);">Promotional On Sale</a></li>
	</ul>
	<div class="col-sm-6 onsaleCattitle" id="cattitleLeft">
		<div class="cattitle">
			<h1>Promotional On Sale Items</h1>
	...
	<div class="col-sm-6 onsaleCattitle" id="cattitleRight">
		<div class="col-lg-6 col-sm-12" id="cattitleTop">
			...
			<img src="{{ asset('staticfile/images/saveupto30.png')}}" alt="save up to 30" class="img-responsive"/>
...
@php
$on_sale_category = App\Models\Category::where('on_sale',1)->get();
$tcategories = App\Models\Category::where('on_sale', 1)->pluck('id')->toArray();
$featured_products = App\Models\Product::where('trend_product',1)->whereIn('category_id', $tcategories)->take(3)->get();
@endphp
...
@endif
@if(count($on_sale_category) > 0)
<div id="category-product" class="container">
	@foreach($on_sale_category as $category)
...
@else
<center style="padding: 100px;"><h4>No Category Available Under On Sale</h4></center>
@endif
</div>
