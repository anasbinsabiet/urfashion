                            ...
                            <div class="bg-white shadow-sm rounded mb-3">
                                ...
                                <div class="p-3">
                                    <ul class="list-unstyled">
                                        <li class="mb-2">
                                            <a class="text-reset fs-14 fw-600" href="{{url('products')}}">
                                                <i class="las la-angle-left"></i>
                                                All categories
                                            </a>
                                        </li>
										@php
										$p_cat = App\Models\Category::where('id',$current_cat->id)->first();
										$p_cat_name = App\Models\Category::where('id',$p_cat->parent_id)->first();
										@endphp
                                        <li class="mb-2">
                                            <a class="text-reset fs-14 fw-600" href="{{ url('category', $p_cat_name->slug) }}">
                                                <i class="las la-angle-left"></i>
                                                {{ $p_cat_name->category_name }}
                                            </a>
                                        </li>
                                        <li class="mb-2">
                                        ...
                                        @else
                                            ...
                                            <li class="ml-4 mb-2">
                                                <a class="text-reset fs-14" href="{{ url('subcategory', $pcat->slug) }}">{{$pcat->category_name}}</a>
                                            </li>
                                            @endforeach
                                        @endif
                                    </ul>
                        ...
                        <div class="col mb-3">
                            <div class="aiz-card-box h-100 border border-light rounded shadow-sm hov-shadow-md has-transition bg-white">
                                <div class="position-relative">
                                    <a href="https://circle.com.bd/product/Heavy-Embroidery-Work--Single-koti--KOT022" class="d-block">
                                    ...
                                    <div class="absolute-top-right aiz-p-hov-icon">
                                        <a href="javascript:void(0)" onclick="addToWishList(14695)" data-toggle="tooltip" data-title="Add to wishlist" data-placement="left" data-original-title="" title="">
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    ...
                                    <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0">
                                        <a href="https://circle.com.bd/product/Heavy-Embroidery-Work--Single-koti--KOT022" class="d-block text-reset">{{ $row->product_name }}</a>
                                    </h3>
