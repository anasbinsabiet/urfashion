            ...
            <div class="row">
					<div data-v-347aff46="" id="categories-block-container">
						<div data-v-347aff46="" id="categories-block-wrapper" class="grid">
							...
							@endphp
							@foreach($help as $row)
							<div data-v-20a3e84e="" data-v-347aff46="" class="category-block grid"><a data-v-20a3e84e="" href="/category/make-an-order" class="link">
							...
							<main id="main" class="site-main" role="main">
								<article id="post-3414" class="post-3414 post type-post status-publish format-standard has-post-thumbnail hentry category-branding-2 category-business-marketing category-promotional-products-2 tag-advertising-calendar tag-business-card-magnet-calendars tag-personalized-calanders tag-personalized-calendars-custom-desk-calendars tag-personalized-monthly-planner tag-promotional-calendars">
									<header class="single-entry-header">
										<h1 class="single-entry-title entry-title m-0 text-left">hcat category_name</h1>
									</header><!-- .entry-header -->
									<div class="article-featured-image">
									</div>
									<br/>
									<div class="entry-content">
										<!-- {!! $hcat->description_en !!}s -->
									</div><!-- .entry-content -->
								</article><!-- #post-## -->
							</main><!-- #main -->
						</div><!-- #primary -->
								...
								<div class="textwidget">
									...
									<nav class="navigation post-navigation" role="navigation">
										...
										@foreach($blogs as $row)
											<li><a href="{{url(route('blog'))}}/{{$row->slug_en}}"><img width="auto" height="100" @if($row->image) src="{{url($row->image)}}" @else src="{{url('defaults/noimage/no_img.jpg')}}" @endif class="attachment-featured-slider size-featured-slider wp-post-image" alt="{{$row->title_en}}" loading="lazy">{{$row->title_en}}</a></li>
										@endforeach
											</ul>
										</div><!-- .nav-links -->
									</nav><!-- .navigation -->
